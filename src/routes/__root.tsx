...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tell Tonight your mood and get one perfect movie or show pick: with the platform, rating, and reason why." },
      { name: "author", content: "Tonight" },
